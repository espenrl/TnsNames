...
namespace erl.Oracle.TnsNames.Antlr4.Runtime
{
    ...
    public interface IParserErrorListener : IAntlrErrorListener<IToken>
    {
        ...
        /// will call either
        /// <see cref="ReportContextSensitivity(Parser, erl.Oracle.TnsNames.Antlr4.Runtime.Dfa.DFA, int, int, int, erl.Oracle.TnsNames.Antlr4.Runtime.Atn.SimulatorState)"/>
        /// or
        /// <see cref="ReportAmbiguity(Parser, erl.Oracle.TnsNames.Antlr4.Runtime.Dfa.DFA, int, int, bool, erl.Oracle.TnsNames.Antlr4.Runtime.Sharpen.BitSet, erl.Oracle.TnsNames.Antlr4.Runtime.Atn.ATNConfigSet)"/>
        /// .</p>
        /// <p>
        /// When
        ...
        /// <see cref="erl.Oracle.TnsNames.Antlr4.Runtime.Atn.ParserATNSimulator"/>
        ...
        /// <see cref="erl.Oracle.TnsNames.Antlr4.Runtime.Atn.DecisionInfo.contextSensitivities"/>
        /// .
