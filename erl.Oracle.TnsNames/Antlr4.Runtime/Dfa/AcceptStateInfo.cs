...
namespace erl.Oracle.TnsNames.Antlr4.Runtime.Dfa
{
    ...
    /// <see cref="erl.Oracle.TnsNames.Antlr4.Runtime.Atn.ParserATNSimulator.PredictionMode()"/>
    ...
    public class AcceptStateInfo
    {
        ...
        private readonly erl.Oracle.TnsNames.Antlr4.Runtime.Atn.LexerActionExecutor lexerActionExecutor;
        ...
        /// <summary>
        /// Gets the
        /// <see cref="erl.Oracle.TnsNames.Antlr4.Runtime.Atn.LexerActionExecutor"/>
        /// which can be used to execute actions
        /// and/or commands after the lexer matches a token.
        /// </summary>
        public virtual erl.Oracle.TnsNames.Antlr4.Runtime.Atn.LexerActionExecutor LexerActionExecutor
        {
            get
            {
