...
namespace erl.Oracle.TnsNames.Antlr4.Runtime.Dfa
{
        ...
        where T : class
    {
        ...
        public override AbstractEdgeMap<T> Put(int key, T value)
        {
            ...
            {
                return new erl.Oracle.TnsNames.Antlr4.Runtime.Dfa.SingletonEdgeMap<T>(minIndex, maxIndex, key, value);
            }
            else
            {
                if (value != null)
        ...
        public override IDictionary<int, T> ToMap()
        {
            ...
            return erl.Oracle.TnsNames.Antlr4.Runtime.Sharpen.Collections.SingletonMap(key, value);
        }
    }
}
