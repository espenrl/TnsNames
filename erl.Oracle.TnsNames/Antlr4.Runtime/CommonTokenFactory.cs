...
namespace erl.Oracle.TnsNames.Antlr4.Runtime
{
    ...
    public class CommonTokenFactory : ITokenFactory
    {
        ...
        /// tokens.</p>
        /// </summary>
        public static readonly ITokenFactory Default = new erl.Oracle.TnsNames.Antlr4.Runtime.CommonTokenFactory();
        ...
        /// implementation of
        /// <see cref="ICharStream.GetText(erl.Oracle.TnsNames.Antlr4.Runtime.Misc.Interval)"/>
        /// in
