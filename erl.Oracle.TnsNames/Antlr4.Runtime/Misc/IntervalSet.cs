...
namespace erl.Oracle.TnsNames.Antlr4.Runtime.Misc
{
    ...
    {
        public static readonly erl.Oracle.TnsNames.Antlr4.Runtime.Misc.IntervalSet CompleteCharSet = erl.Oracle.TnsNames.Antlr4.Runtime.Misc.IntervalSet.Of(Lexer.MinCharValue, Lexer.MaxCharValue);

        public static readonly erl.Oracle.TnsNames.Antlr4.Runtime.Misc.IntervalSet EmptySet = new erl.Oracle.TnsNames.Antlr4.Runtime.Misc.IntervalSet();
        ...
        public static erl.Oracle.TnsNames.Antlr4.Runtime.Misc.IntervalSet Of(int a, int b)
        {
            erl.Oracle.TnsNames.Antlr4.Runtime.Misc.IntervalSet s = new erl.Oracle.TnsNames.Antlr4.Runtime.Misc.IntervalSet();
            s.Add(a, b);
            return s;
        ...
        public virtual erl.Oracle.TnsNames.Antlr4.Runtime.Misc.IntervalSet Complement(int minElement, int maxElement)
        {
            return this.Complement(erl.Oracle.TnsNames.Antlr4.Runtime.Misc.IntervalSet.Of(minElement, maxElement));
        }
