...
namespace erl.Oracle.TnsNames.Antlr4.Runtime.Atn
{
    ...
    /// <see cref="erl.Oracle.TnsNames.Antlr4.Runtime.Lexer.PushMode(int)"/>
    ...
    public sealed class LexerPushModeAction : ILexerAction
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            {
                if (!(obj is erl.Oracle.TnsNames.Antlr4.Runtime.Atn.LexerPushModeAction))
                {
                    return false;
                }
            }
            return mode == ((erl.Oracle.TnsNames.Antlr4.Runtime.Atn.LexerPushModeAction)obj).mode;
        }
