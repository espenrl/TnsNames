...
namespace erl.Oracle.TnsNames.Antlr4.Runtime.Atn
{
    ...
    /// <see cref="AddDFAEdge(erl.Oracle.TnsNames.Antlr4.Runtime.Dfa.DFAState, int, erl.Oracle.TnsNames.Antlr4.Runtime.Dfa.DFAState)"/>
    /// locks on the DFA for the current decision when setting the
    /// <see cref="DFAState.edges"/>
    /// field.
    /// <see cref="AddDFAState(erl.Oracle.TnsNames.Antlr4.Runtime.Dfa.DFA, ATNConfigSet, PredictionContextCache)"/>
    /// locks on
    ...
    /// <see cref="erl.Oracle.TnsNames.Antlr4.Runtime.Dfa.DFAState"/>
    /// , or
    /// <see langword="null"/>
    /// . Once into the DFA, the DFA simulation does not reference the
    /// <see cref="erl.Oracle.TnsNames.Antlr4.Runtime.Dfa.DFA.states"/>
    /// map. It follows the
    /// <see cref="DFAState.edges"/>
    /// field to new
    ...
    /// mode with the
    /// <see cref="erl.Oracle.TnsNames.Antlr4.Runtime.BailErrorStrategy"/>
    /// :</p>
    /// <pre>
    /// parser.
    /// <see cref="erl.Oracle.TnsNames.Antlr4.Runtime.Recognizer{Symbol, ATNInterpreter}.Interpreter()">getInterpreter()</see>
    /// .
...
#pragma warning disable 0162 // Unreachable code detected
        ...
        [NotNull]
        private erl.Oracle.TnsNames.Antlr4.Runtime.Atn.PredictionMode predictionMode = erl.Oracle.TnsNames.Antlr4.Runtime.Atn.PredictionMode.Ll;
        ...
        [Nullable]
        protected internal readonly erl.Oracle.TnsNames.Antlr4.Runtime.Parser parser;
        ...
        /// encountered within
        /// <see cref="ExecATN(erl.Oracle.TnsNames.Antlr4.Runtime.Dfa.DFA, erl.Oracle.TnsNames.Antlr4.Runtime.ITokenStream, int, SimulatorState)"/>
        /// . When
        /// <see langword="false"/>
        /// , these messages
        ...
        public ParserATNSimulator(erl.Oracle.TnsNames.Antlr4.Runtime.Parser parser, ATN atn)
            : base(atn)
        {
            this.parser = parser;
        }

        public erl.Oracle.TnsNames.Antlr4.Runtime.Atn.PredictionMode PredictionMode
        {
            get
            {
            ...
            set
            {
                erl.Oracle.TnsNames.Antlr4.Runtime.Atn.PredictionMode predictionMode = value;
        ...
        public virtual int AdaptivePredict(ITokenStream input, int decision, ParserRuleContext outerContext, bool useContext)
        {
            ...
            userWantsCtxSensitive = useContext || (predictionMode != erl.Oracle.TnsNames.Antlr4.Runtime.Atn.PredictionMode.Sll && outerContext != null && !atn.decisionToState[decision].sll);
        ...
        protected internal virtual int ExecDFA(DFA dfa, ITokenStream input, int startIndex, SimulatorState state)
        {
            ...
            if (predicates_1 != null)
            {
                ...
                BitSet alts = EvalSemanticContext(predicates_1, outerContext, reportAmbiguities && predictionMode == erl.Oracle.TnsNames.Antlr4.Runtime.Atn.PredictionMode.LlExactAmbigDetection);
        ...
        /// <see cref="erl.Oracle.TnsNames.Antlr4.Runtime.Dfa.DFAState.IsAcceptState()"/>
        ...
        protected internal virtual bool IsAcceptState(DFAState state, bool useContext)
        {
            ...
            if (useContext && predictionMode == erl.Oracle.TnsNames.Antlr4.Runtime.Atn.PredictionMode.LlExactAmbigDetection)
            {
        ...
        /// <see cref="erl.Oracle.TnsNames.Antlr4.Runtime.NoViableAltException"/>
        ...
        /// <see cref="erl.Oracle.TnsNames.Antlr4.Runtime.ParserRuleContext"/>
        ...
        /// <see cref="erl.Oracle.TnsNames.Antlr4.Runtime.FailedPredicateException"/>
        /// in
        /// parser. Specifically, this could occur if the <em>only</em> configuration
        /// capable of successfully parsing to the end of the decision rule is
        /// blocked by a semantic predicate. By choosing this alternative within
        /// <see cref="AdaptivePredict(erl.Oracle.TnsNames.Antlr4.Runtime.ITokenStream, int, erl.Oracle.TnsNames.Antlr4.Runtime.ParserRuleContext)"/>
        ...
        /// <param name="input">
        /// The input
        /// <see cref="erl.Oracle.TnsNames.Antlr4.Runtime.ITokenStream"/>
        /// </param>
        ...
        protected internal virtual Tuple<DFAState, ParserRuleContext> ComputeTargetState(DFA dfa, DFAState s, ParserRuleContext remainingGlobalContext, int t, bool useContext, PredictionContextCache contextCache)
        {
            ...
            do
            {
                ...
                */
                if (skippedStopStates != null && (!useContext || !erl.Oracle.TnsNames.Antlr4.Runtime.Atn.PredictionMode.HasConfigInRuleStopState(reach)))
                {
        ...
        {
            if (erl.Oracle.TnsNames.Antlr4.Runtime.Atn.PredictionMode.AllConfigsInRuleStopStates(configs))
            {
                return configs;
            }
        ...
        /// <see cref="ComputeStartState(erl.Oracle.TnsNames.Antlr4.Runtime.Dfa.DFA, erl.Oracle.TnsNames.Antlr4.Runtime.ParserRuleContext, bool)"/>
        ...
        /// <see cref="SemanticContext.EvalPrecedence{Symbol, ATNInterpreter}(erl.Oracle.TnsNames.Antlr4.Runtime.Recognizer{Symbol, ATNInterpreter}, erl.Oracle.TnsNames.Antlr4.Runtime.RuleContext)"/>
        /// .</li>
        /// <li>When
        ...
        /// calling
        /// <see cref="erl.Oracle.TnsNames.Antlr4.Runtime.Parser.Precedence()"/>
        /// ).
        /// </returns>
        [return: NotNull]
        ...
        */
        ...
        protected internal virtual void Closure(ATNConfig config, ATNConfigSet configs, ATNConfigSet intermediate, HashSet<ATNConfig> closureBusy, bool collectPredicates, bool hasMoreContexts, PredictionContextCache contextCache, int depth, bool treatEofAsEpsilon)
        {
            ...
            for (int i_1 = 0; i_1 < p.NumberOfOptimizedTransitions; i_1++)
            {
                ...
                bool continueCollecting = !(t is erl.Oracle.TnsNames.Antlr4.Runtime.Atn.ActionTransition) && collectPredicates;
                ATNConfig c = GetEpsilonTarget(config, t, continueCollecting, depth == 0, contextCache, treatEofAsEpsilon);
                if (c != null)
                {
                    if (t is erl.Oracle.TnsNames.Antlr4.Runtime.Atn.RuleTransition)
                    {
                    ...
                    else
                    {
                        if (t is erl.Oracle.TnsNames.Antlr4.Runtime.Atn.RuleTransition)
                        {
                            if (optimize_tail_calls && ((erl.Oracle.TnsNames.Antlr4.Runtime.Atn.RuleTransition)t).optimizedTailCall && (!tail_call_preserves_sll || !PredictionContext.IsEmptyLocal(config.Context)))
                            {
        ...
        protected internal virtual ATNConfig GetEpsilonTarget(ATNConfig config, Transition t, bool collectPredicates, bool inContext, PredictionContextCache contextCache, bool treatEofAsEpsilon)
        {
            switch (t.TransitionType)
            {
                ...
                {
                    return RuleTransition(config, (erl.Oracle.TnsNames.Antlr4.Runtime.Atn.RuleTransition)t, contextCache);
                }
                ...
                {
                    return ActionTransition(config, (erl.Oracle.TnsNames.Antlr4.Runtime.Atn.ActionTransition)t);
                }
        ...
        [return: NotNull]
        protected internal virtual ATNConfig ActionTransition(ATNConfig config, erl.Oracle.TnsNames.Antlr4.Runtime.Atn.ActionTransition t)
        {
            return config.Transform(t.target, false);
        }
        ...
        [return: NotNull]
        protected internal virtual ATNConfig RuleTransition(ATNConfig config, erl.Oracle.TnsNames.Antlr4.Runtime.Atn.RuleTransition t, PredictionContextCache contextCache)
        {
        ...
        protected internal int GetReturnState(RuleContext context)
        {
            ...
            erl.Oracle.TnsNames.Antlr4.Runtime.Atn.RuleTransition transition = (erl.Oracle.TnsNames.Antlr4.Runtime.Atn.RuleTransition)state.Transition(0);
        ...
        /// <since>4.3</since>
        public virtual erl.Oracle.TnsNames.Antlr4.Runtime.Parser Parser
        {
            get
            {
                return parser;
