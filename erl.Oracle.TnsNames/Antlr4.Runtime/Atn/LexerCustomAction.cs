...
namespace erl.Oracle.TnsNames.Antlr4.Runtime.Atn
{
    ...
    public sealed class LexerCustomAction : ILexerAction
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            {
                if (!(obj is erl.Oracle.TnsNames.Antlr4.Runtime.Atn.LexerCustomAction))
                {
                    return false;
                }
            }
            erl.Oracle.TnsNames.Antlr4.Runtime.Atn.LexerCustomAction other = (erl.Oracle.TnsNames.Antlr4.Runtime.Atn.LexerCustomAction)obj;
