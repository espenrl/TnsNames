...
namespace erl.Oracle.TnsNames.Antlr4.Runtime.Atn
{
    ...
    public class ConflictInfo
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            {
                if (!(obj is erl.Oracle.TnsNames.Antlr4.Runtime.Atn.ConflictInfo))
                {
                    return false;
                }
            }
            erl.Oracle.TnsNames.Antlr4.Runtime.Atn.ConflictInfo other = (erl.Oracle.TnsNames.Antlr4.Runtime.Atn.ConflictInfo)obj;
