...
namespace erl.Oracle.TnsNames.Antlr4.Runtime.Atn
{
    ...
    public sealed class LexerIndexedCustomAction : ILexerAction
    {
        ...
        /// <inheritDoc/>
        /// <p>This method calls
        /// <see cref="Execute(erl.Oracle.TnsNames.Antlr4.Runtime.Lexer)"/>
        /// on the result of
        /// <see cref="Action()"/>
        /// using the provided
        /// <paramref name="lexer"/>
        ...
        public override bool Equals(object obj)
        {
            ...
            {
                if (!(obj is erl.Oracle.TnsNames.Antlr4.Runtime.Atn.LexerIndexedCustomAction))
                {
                    return false;
                }
            }
            erl.Oracle.TnsNames.Antlr4.Runtime.Atn.LexerIndexedCustomAction other = (erl.Oracle.TnsNames.Antlr4.Runtime.Atn.LexerIndexedCustomAction)obj;
