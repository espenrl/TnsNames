...
namespace erl.Oracle.TnsNames.Antlr4.Runtime.Atn
{
    ...
    /// input.</p>
    /// </remarks>
    /// <seealso cref="ParserATNSimulator.ReportContextSensitivity(erl.Oracle.TnsNames.Antlr4.Runtime.Dfa.DFA, int, SimulatorState, int, int)"/>
    /// <seealso cref="erl.Oracle.TnsNames.Antlr4.Runtime.IParserErrorListener.ReportContextSensitivity(erl.Oracle.TnsNames.Antlr4.Runtime.Parser, erl.Oracle.TnsNames.Antlr4.Runtime.Dfa.DFA, int, int, int, SimulatorState)"/>
    /// <since>4.3</since>
