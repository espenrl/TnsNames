...
namespace erl.Oracle.TnsNames.Antlr4.Runtime.Atn
{
    ...
    public sealed class LexerChannelAction : ILexerAction
    {
        ...
        /// <see cref="erl.Oracle.TnsNames.Antlr4.Runtime.IToken"/>
        ...
        public override bool Equals(object obj)
        {
            ...
            {
                if (!(obj is erl.Oracle.TnsNames.Antlr4.Runtime.Atn.LexerChannelAction))
                {
                    return false;
                }
            }
            return channel == ((erl.Oracle.TnsNames.Antlr4.Runtime.Atn.LexerChannelAction)obj).channel;
        }
