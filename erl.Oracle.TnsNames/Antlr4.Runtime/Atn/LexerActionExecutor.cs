...
namespace erl.Oracle.TnsNames.Antlr4.Runtime.Atn
{
    ...
    /// <see cref="erl.Oracle.TnsNames.Antlr4.Runtime.Dfa.DFA"/>
    ...
    public class LexerActionExecutor
    {
        ...
        /// </returns>
        public virtual erl.Oracle.TnsNames.Antlr4.Runtime.Atn.LexerActionExecutor FixOffsetBeforeMatch(int offset)
        {
            ...
            return new erl.Oracle.TnsNames.Antlr4.Runtime.Atn.LexerActionExecutor(updatedLexerActions);
        }
        ...
        /// <see cref="erl.Oracle.TnsNames.Antlr4.Runtime.IIntStream.Index()"/>
        /// for
        /// <paramref name="input"/>
