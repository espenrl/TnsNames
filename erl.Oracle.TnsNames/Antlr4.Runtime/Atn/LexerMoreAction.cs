...
namespace erl.Oracle.TnsNames.Antlr4.Runtime.Atn
{
    ...
    /// <see cref="erl.Oracle.TnsNames.Antlr4.Runtime.Lexer.More()"/>
    /// .
    /// <p>The
    /// <c>more</c>
    ...
    public sealed class LexerMoreAction : ILexerAction
    {
        ...
        public static readonly erl.Oracle.TnsNames.Antlr4.Runtime.Atn.LexerMoreAction Instance = new erl.Oracle.TnsNames.Antlr4.Runtime.Atn.LexerMoreAction();
