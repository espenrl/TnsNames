...
namespace erl.Oracle.TnsNames.Antlr4.Runtime.Atn
{
    ...
    {
        protected internal readonly erl.Oracle.TnsNames.Antlr4.Runtime.Atn.DecisionInfo[] decisions;
            ...
            : base(parser, parser.Interpreter.atn)
        {
            ...
            decisions = new erl.Oracle.TnsNames.Antlr4.Runtime.Atn.DecisionInfo[numDecisions];
            for (int i = 0; i < numDecisions; i++)
            {
                decisions[i] = new erl.Oracle.TnsNames.Antlr4.Runtime.Atn.DecisionInfo(i);
            }
        }
        ...
        public virtual erl.Oracle.TnsNames.Antlr4.Runtime.Atn.DecisionInfo[] DecisionInfo
        {
            get
            {
                // ---------------------------------------------------------------------
