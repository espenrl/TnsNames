...
#pragma warning disable 0659 // 'class' overrides Object.Equals(object o) but does not override Object.GetHashCode()
    public class ArrayPredictionContext : PredictionContext
    {
        ...
        protected internal override PredictionContext AddEmptyContext()
        {
            ...
            return new erl.Oracle.TnsNames.Antlr4.Runtime.Atn.ArrayPredictionContext(parents2, returnStates2);
        }
            ...
            if (!visited.TryGetValue(context, out result))
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        result = new erl.Oracle.TnsNames.Antlr4.Runtime.Atn.ArrayPredictionContext(updatedParents, updatedReturnStates);
                    }
                    if (context.HasEmpty)
                    {
        ...
        public override bool Equals(object o)
        {
            ...
            {
                if (!(o is erl.Oracle.TnsNames.Antlr4.Runtime.Atn.ArrayPredictionContext))
                {
                    return false;
                }
            }
            ...
            erl.Oracle.TnsNames.Antlr4.Runtime.Atn.ArrayPredictionContext other = (erl.Oracle.TnsNames.Antlr4.Runtime.Atn.ArrayPredictionContext)o;
            return Equals(other, new HashSet<PredictionContextCache.IdentityCommutativePredictionContextOperands>());
        }

        private bool Equals(erl.Oracle.TnsNames.Antlr4.Runtime.Atn.ArrayPredictionContext other, HashSet<PredictionContextCache.IdentityCommutativePredictionContextOperands> visited)
        {
