...
namespace erl.Oracle.TnsNames.Antlr4.Runtime.Atn
{
    ...
    /// <see cref="erl.Oracle.TnsNames.Antlr4.Runtime.Lexer.Mode(int)"/>
    /// with
    /// the assigned mode.
    /// </summary>
    ...
    public sealed class LexerModeAction : ILexerAction
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            {
                if (!(obj is erl.Oracle.TnsNames.Antlr4.Runtime.Atn.LexerModeAction))
                {
                    return false;
                }
            }
            return mode == ((erl.Oracle.TnsNames.Antlr4.Runtime.Atn.LexerModeAction)obj).mode;
        }
