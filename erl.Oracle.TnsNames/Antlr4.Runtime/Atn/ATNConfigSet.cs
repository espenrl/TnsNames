...
namespace erl.Oracle.TnsNames.Antlr4.Runtime.Atn
{
    ...
    public class ATNConfigSet : IEnumerable<ATNConfig>
    {
        ...
        protected internal ATNConfigSet(erl.Oracle.TnsNames.Antlr4.Runtime.Atn.ATNConfigSet set, bool @readonly)
        {
            if (@readonly)
            {
        ...
        public virtual erl.Oracle.TnsNames.Antlr4.Runtime.Atn.ATNConfigSet Clone(bool @readonly)
        {
            erl.Oracle.TnsNames.Antlr4.Runtime.Atn.ATNConfigSet copy = new erl.Oracle.TnsNames.Antlr4.Runtime.Atn.ATNConfigSet(this, @readonly);
        ...
        public override bool Equals(object obj)
        {
            ...
            if (!(obj is erl.Oracle.TnsNames.Antlr4.Runtime.Atn.ATNConfigSet))
            {
                return false;
            }
            erl.Oracle.TnsNames.Antlr4.Runtime.Atn.ATNConfigSet other = (erl.Oracle.TnsNames.Antlr4.Runtime.Atn.ATNConfigSet)obj;
