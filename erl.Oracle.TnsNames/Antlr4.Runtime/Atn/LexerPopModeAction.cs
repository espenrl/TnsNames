...
namespace erl.Oracle.TnsNames.Antlr4.Runtime.Atn
{
    ...
    /// <see cref="erl.Oracle.TnsNames.Antlr4.Runtime.Lexer.PopMode()"/>
    /// .
    /// <p>The
    /// <c>popMode</c>
    ...
    public sealed class LexerPopModeAction : ILexerAction
    {
        ...
        public static readonly erl.Oracle.TnsNames.Antlr4.Runtime.Atn.LexerPopModeAction Instance = new erl.Oracle.TnsNames.Antlr4.Runtime.Atn.LexerPopModeAction();
