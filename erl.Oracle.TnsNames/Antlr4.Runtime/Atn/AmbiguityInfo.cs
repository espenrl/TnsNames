...
namespace erl.Oracle.TnsNames.Antlr4.Runtime.Atn
{
    ...
    /// for that input.</p>
    /// </remarks>
    /// <seealso cref="ParserATNSimulator.ReportAmbiguity(erl.Oracle.TnsNames.Antlr4.Runtime.Dfa.DFA, erl.Oracle.TnsNames.Antlr4.Runtime.Dfa.DFAState, int, int, bool, erl.Oracle.TnsNames.Antlr4.Runtime.Sharpen.BitSet, ATNConfigSet)"/>
    /// <seealso cref="erl.Oracle.TnsNames.Antlr4.Runtime.IParserErrorListener.ReportAmbiguity(erl.Oracle.TnsNames.Antlr4.Runtime.Parser, erl.Oracle.TnsNames.Antlr4.Runtime.Dfa.DFA, int, int, bool, erl.Oracle.TnsNames.Antlr4.Runtime.Sharpen.BitSet, ATNConfigSet)"/>
    /// <since>4.3</since>
