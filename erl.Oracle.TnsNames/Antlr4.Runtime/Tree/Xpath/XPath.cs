...
namespace erl.Oracle.TnsNames.Antlr4.Runtime.Tree.Xpath
{
    ...
    /// <see cref="FindAll(erl.Oracle.TnsNames.Antlr4.Runtime.Tree.IParseTree, string, erl.Oracle.TnsNames.Antlr4.Runtime.Parser)">ParseTree.findAll</see>
    ...
    /// <see cref="XPath"/>
    /// p = new
    /// <see cref="XPath(erl.Oracle.TnsNames.Antlr4.Runtime.Parser, string)">XPath</see>
    /// (parser, pathString);
    /// return p.
    /// <see cref="Evaluate(erl.Oracle.TnsNames.Antlr4.Runtime.Tree.IParseTree)">evaluate</see>
    /// (tree);
    /// </pre>
    /// <p>
    /// See
...
loop_break: ;
        ...
        {
            erl.Oracle.TnsNames.Antlr4.Runtime.Tree.Xpath.XPath p = new erl.Oracle.TnsNames.Antlr4.Runtime.Tree.Xpath.XPath(parser, xpath);
        ...
        /// <see cref="Evaluate(erl.Oracle.TnsNames.Antlr4.Runtime.Tree.IParseTree)"/>
        /// .
        /// </summary>
        public virtual ICollection<IParseTree> Evaluate(IParseTree t)
        {
            ParserRuleContext dummyRoot = new ParserRuleContext();
            dummyRoot.children = erl.Oracle.TnsNames.Antlr4.Runtime.Sharpen.Collections.SingletonList(t);
