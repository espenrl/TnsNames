...
namespace erl.Oracle.TnsNames.Antlr4.Runtime
{
    ...
    public abstract class Parser : Recognizer<IToken, ParserATNSimulator>
    {
        ...
        /// bypass alternatives.
        /// </summary>
        /// <seealso cref="erl.Oracle.TnsNames.Antlr4.Runtime.Atn.ATNDeserializationOptions.GenerateRuleBypassTransitions()"/>
        ...
        /// <summary>
        /// The list of
        /// <see cref="erl.Oracle.TnsNames.Antlr4.Runtime.Tree.IParseTreeListener"/>
        ...
        /// <see cref="erl.Oracle.TnsNames.Antlr4.Runtime.Tree.ParseTreeWalker.Default"/>
        ...
        /// respectively.
        /// </summary>
        /// <seealso cref="erl.Oracle.TnsNames.Antlr4.Runtime.Atn.ATN.GetExpectedTokens(int, RuleContext)"/>
        [return: NotNull]
